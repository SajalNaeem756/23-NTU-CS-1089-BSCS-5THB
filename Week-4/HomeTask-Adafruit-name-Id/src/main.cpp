...
void loop() {
  ...
  display.println("Sajal Naeem");      // Replace with your name

  display.setTextSize(1);            // Small text for ID
  display.setCursor(10, 25);         // Position for ID below name
  display.println("23-NTU-CS-1089");        // Replace with your ID

  // --- Draw a rectangle around the text ---
  // Parameters: x, y, width, height, color
  display.drawRect(5, 5, 118, 35, SSD1306_WHITE); // Adjust as needed
